...
ActiveRecord::Schema.define(version: 20170608024642) do
  ...
  create_table "administrations", force: :cascade do |t|
    ...
    t.index ["institution_id"], name: "index_administrations_on_institution_id", using: :btree
    t.index ["user_id"], name: "index_administrations_on_user_id", using: :btree
  end
